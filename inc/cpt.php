    ...
    */
						...
						function( $post, $data ) {
			                ...
			                if( ! empty( $custom_fields ) ) {
			                    ...
			                    foreach( $custom_fields as $field ) {
			                    	...
			                    	$prefix = '_tcu_';
			                        $field_id_name  = $prefix . call_user_func("CPT::uglify", $field['name']);
			                        ...
			                        switch ( $field['type'] ) {
				                        ...
				                        // Image
				                        case 'image':
				                        	$image = get_template_directory_uri(). '/img/ui/image.png';
				                        	...
				                        	if ( empty($meta) ) {
					                        	...
					                        	echo '<img class="custom_media_image '.$field['id'].'" src="'.esc_url($meta).'" width="300"/><br />';
											}
    ...
    public function save() {
     ...
     public function add_custom_js_css() {
        ...
        wp_enqueue_script( 'jquery_ui', get_template_directory_uri() . '/js/min/site-min.js', array( 'jquery' ),'1.11.4', true );
		wp_enqueue_script( 'jquery-maskedinput', get_template_directory_uri() . '/js/min/jquery.maskedinput.min.js', array('jquery'),'1.3.1', true );
		wp_enqueue_script('scripts-helper', get_template_directory_uri() . '/js/min//scripts-min.js', array('jquery', 'jquery-maskedinput', 'jquery_ui'), '1.10.4', 'all');
        wp_enqueue_style('jquery-ui-css', get_template_directory_uri() . '/css/min/jquery-ui.css', false, '1.11.4', 'all');
        wp_enqueue_style('tcu-css',get_template_directory_uri() . '/css/custom-post-types-styles.css', false, false, 'all');
    }
	    		...
	    		foreach( $fields as $field ) {
	    			...
	    			if ( $field['type'] == 'date' ) {
						...
						if( wp_script_is($handle, 'done') ) {
							...
							wp_register_script( 'date-helper', get_template_directory_uri() . '/js/date.js');
